...
public class _1519_Number_of_Nodes_in_the_Sub_Tree_With_the_Same_Label {
    ...
    private void dfs(Map<Integer, List<Integer>> adj, int curr, int parent, int[] count, String labels, int[] result) {

        char currLabel = labels.charAt(curr);
        int beforeCountOfCurrSubTree = count[currLabel - 'a'];
        ...
        int afterCountOfCurrSubTree = count[currLabel - 'a'];

        result[curr] = afterCountOfCurrSubTree - beforeCountOfCurrSubTree;
    }
