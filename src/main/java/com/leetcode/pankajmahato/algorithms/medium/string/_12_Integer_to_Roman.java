...
//        while (num > 0) {
//
//            int index = getMaxEquivalentNumberIndex(num, decimal);
//            int rep = num / decimal[index];
//            for (int i = 1; i <= rep; i++) {
//                result.append(roman[index]);
//            }
//
//            num = num % decimal[index];
//        }
//
//        return result.toString();
//    }
//
//    private int getMaxEquivalentNumberIndex(int num, int[] decimal) {
//
