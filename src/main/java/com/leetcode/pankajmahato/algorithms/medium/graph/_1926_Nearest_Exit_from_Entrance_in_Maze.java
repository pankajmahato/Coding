...
public class _1926_Nearest_Exit_from_Entrance_in_Maze {
    ...
    public int nearestExit(char[][] maze, int[] entrance) {
        ...
        while (!queue.isEmpty()) {
            ...
            while (size-- > 0) {
                ...
                if (isExit(i, j, m, n) && !(i == entrance[0] && j == entrance[1])) {
                    return steps;
                }
    ...
    private boolean canMove(int i, int j, int m, int n, char[][] maze) {
        return i >= 0 && i < m && j >= 0 && j < n && maze[i][j] == '.';
    }

    private boolean isExit(int i, int j, int m, int n) {
